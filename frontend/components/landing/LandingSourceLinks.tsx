...
export const DEVELOPER_SITE_URL = "https://utkarshkumar.vercel.app/";

const linkClass =
  "inline-flex items-center gap-1.5 text-muted transition-colors hover:text-foreground focus-visible:outline-none focus-visible:text-foreground focus-visible:underline";

export function LandingSourceLinks({ className }: { className?: string }) {
  return (
    <nav
